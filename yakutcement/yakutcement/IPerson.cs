...
namespace yakutcement
{
    public class IPerson
    {
        ...
        {
            if (user.Equals(EditingPerson)) return true;
            else return false;
        }
        ...
        public static void EditPerson(int EditingPerson_id, Person user, DBContext db, string fName, string sName, string lName, DateTime bDay, Position pos, double salary, Level level, string login, string password)
        {
            ...
            else System.Windows.Forms.MessageBox.Show("У вас нет прав");
        }   
    }
}
